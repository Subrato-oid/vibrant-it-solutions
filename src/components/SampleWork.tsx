...
const SampleWork = (
  ...
  <div className="sw">
    <div className="sw1">
      {/* <img src="/images/work/image 18.svg" alt="" id="web-view" />
      <img src="/images/work/image 15.svg" alt="" id="mob-view" /> */}
      <img src={props.webImage!} alt="" id="web-view" />
      <img src={props.mobImage!} alt="" id="mob-view" />
    </div>
    <div className="sw2">
      {/* <img src="/images/work/image 16.svg" alt="" />
      <img src="/images/work/image 17.svg" alt="" /> */}
