...
// type TandCProps = NonNullable<IndexPageFrontmatterType>["TandC"]

const TandC = (): React.ReactElement => (
  <>
    <div className="tech-tales">
      <div className="tales">
        <h5>Terms & Conditions</h5>
        <h1>
          <span className="line1">Terms &</span>
          <span className="line2">Conditions</span>
        </h1>
        <p>Last updated on 25 March, 2023</p>
      </div>
    </div>
