    ...
    <div className="process-container">
      <div className="p-container">
        ...
        <p>
          ...
          our team work closely to ensure that we're on the same page. We draft
          a strategy outlining how we'll implement your idea, making use of the
          latest technologies and savvy strategies.
        </p>
      </div>
